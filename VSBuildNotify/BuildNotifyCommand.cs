...
namespace VSBuildNotify
{
    ...
    internal sealed class BuildNotifyCommand
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BuildNotifyCommand"/> class.
        ...
        {
            // Switch to the main thread - the call to AddCommand in BuildNotifyCommand's constructor requires
            // the UI thread.
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            string title = "BuildNotifyCommand";
